...
pressedWaitTimeMin = 30 -- 按下鼠标之后等待时间下限
pressedWaitTimeMax = 40 -- 按下鼠标之后等待时间上限
releasedWaitTimeMin = 10 -- 松开鼠标之后等待时间下限
releasedWaitTimeMax = 20 -- 松开鼠标之后等待时间上限
mouseShot = true -- 是否鼠标左键开火，若为否则游戏内改建，默认键盘开火
shotKey = "E" -- 键盘开火键，默认字母P，字母E充当传说角色改建
...
function flash_sniper() 
    ...
    Sleep(generateRandomInterval(10,20))
    releaseButtonOrKey()
    Sleep(generateRandomInterval(30,50))
